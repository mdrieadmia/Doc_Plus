        ...
        <div className="container mx-auto px-5">
            <div className="w-full flex gap-20 pt-10">
                <div className="w-1/2">
                    ...
                    <p className="max-w-[470px] text-[#020043]">We are proud to be a trusted healthcare provider in our community, and we look forward to serving you and your family with excellence, integrity, and compassion. Your health is our priority, and we are here for you every step of the way. We believe in treating each patient with dignity, respect, and empathy, ensuring that they receive the attention and care they deserve.
                    </p>
                    <div className="pt-10">
                ...
                <div className="w-1/2 relative">
                    ...
                    <div className="bg-[#343268] w-[395px] py-[50px] px-[30px] rounded-3xl absolute -left-[100px] -bottom-[40px] p-5">
