    ...
    return (
        <div className="container mx-auto bg-[#FFFFF5] p-10 rounded-[32px] mt-[160px]">
            <div className="w-full flex gap-20">
                ...
                <div className="w-1/2 bg-[url('https://i.postimg.cc/Z5qFsptL/Rectangle-27-2.png')] bg-cover bg-center bg-no-repeat rounded-[32px] flex items-end p-5">
            ...
            <div className="pt-[60px] flex gap-[28px]">
                <div className="w-1/2 bg-[url('https://i.postimg.cc/LsdgLfQc/Rectangle-27-1.png')] h-[400px] bg-cover flex items-end bg-center bg-no-repeat rounded-[32px] p-[20px]">
                ...
                <div className="w-1/2 bg-[url('https://i.postimg.cc/sDm4JK8X/Rectangle-27.png')] h-[400px] bg-cover flex items-end bg-center bg-no-repeat rounded-[32px] p-[20px]">
                    <div className="bg-[#02004398] w-[320px] p-[18px] text-white rounded-[32px] ">
