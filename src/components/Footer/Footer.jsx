...
const Footer = () => {
    return (
        <div className="w-full bg-[#020043] mt-[160px]">
                    ...
                    <div className="grid grid-cols-1 justify-between gap-4 md:grid-cols-2">
                        <Typography variant="h5" className="mb-6">
                            ...
                            <div className="text-[#F3F3F5] font-medium">
                                <p className="pt-5">123 Main Street Anytown, USA <span className="block">Postal Code: 12345</span> </p>
                                <p className="pt-10 pb-3">Support: support@oyolloo.com</p>
                        ...
                        <div className="grid grid-cols-3 justify-between gap-4 items-end">
                            ...
                            <div>
                                ...
                                <div>
                                    <h1 className="text-white ml-4 pb-2">&copy;{currentYear} By DOC+</h1>
                                </div>
                            </div>
                        </div>
                    </div>
